...
interface EchoDemoModalProps {
  isOpen: boolean;
  onClose: () => void;
}

export default function EchoDemoModal({ isOpen, onClose }: EchoDemoModalProps) {
              ...
              {step === 'details' && (
                ...
                >
                  ...
                  <p className="mb-6" style={{ color: 'var(--color-text-secondary)' }}>
                    See how Echo can transform your farm. Let's start with your details.
                  </p>
              ...
              {step === 'success' && (
                ...
                >
                  ...
                  <p className="mb-8" style={{ color: 'var(--color-text-secondary)' }}>
                    Thanks, {formData.name.split(' ')[0]}. We've sent a calendar invite to {formData.email}. We look forward to showing you Echo!
                  </p>
                  <button
