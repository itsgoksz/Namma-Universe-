    ...
    <section className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden" style={{ backgroundColor: 'var(--color-bg-primary)' }}>
      ...
      <div className="container relative z-10 px-4 sm:px-6 lg:px-8 mx-auto flex flex-col lg:flex-row items-center gap-16">
        ...
        <div className="flex-1 text-center lg:text-left">
          ...
          >
            A next-generation, AI-driven travel coordination platform for EV drivers. It seamlessly integrates route optimization, charging schedules, dietary preferences, and real-time traffic into a single, elegant dashboard.
          </motion.p>
          ...
          <div className="relative rounded-3xl overflow-hidden glass border border-[var(--color-border)] p-6 sm:p-8 aspect-square lg:aspect-auto lg:h-[600px] flex flex-col justify-center gap-6 shadow-2xl" style={{ backgroundColor: 'var(--color-bg-tertiary)' }}>
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm" style={{ color: 'var(--color-text-secondary)' }}>Steep elevation detected. Vehicle Dynamics Engine recalculating battery consumption. Routing to earlier charger.</p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm" style={{ color: 'var(--color-text-secondary)' }}>Arriving with 18% battery. Pre-conditioning battery for maximum charge rate. Scheduled stop: 24 minutes.</p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm" style={{ color: 'var(--color-text-secondary)' }}>Top-rated vegetarian restaurant located 400ft from charging station. Reserving a table for 12:30 PM.</p>
              </div>
            </motion.div>
